...
export interface SharedEntityPool<TEntity extends SharedEntity> {
    /**
     ...
     */
    forEach(handler: ForEachHandler<TEntity>): void;
     ...
     * @param handler Function that will be called for each entity.
     */
    forEach(dimension: number, handler: ForEachHandler<TEntity>): void;
     ...
     * @param handler Function that will be called for each entity.
     */
    forEach(position: Vector3, range: number, handler: ForEachHandler<TEntity>): void;
     ...
     * @param handler Function that will be called for each entity.
     */
    forEach(position: Vector3, range: number, dimension: number, handler: ForEachHandler<TEntity>): void;
